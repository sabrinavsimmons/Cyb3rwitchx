...
- **Credential Dump Detection Lab** – Detected LSASS dump activity using Sysmon and Windows Event IDs  
- **Windows Event Log Analysis** – Investigated brute-force authentication attempts  
- **Suspicious Login Analysis** – Used Microsoft Sentinel and KQL for detection queries  
- **Threat Actor Simulation** – Simulated PowerShell backdoor activity and analyzed forensic artifacts  
- **Phishing Email Triage** – Investigated a phishing attempt using a SOC-style workflow  
...
- Parsing and interpreting logs for indicators of compromise
